...
const OceanResults = () => {
  ...
  const mbtiDescriptions = {
    INFP: {
      shortDesc:
        'The Mediator - Creative idealists with a strong sense of personal values and a desire to make the world a better place.',
      description:
        'INFPs are imaginative idealists, guided by their own core values and beliefs. They are creative, introspective, and driven by a desire to understand themselves and the world around them. They seek meaning and authenticity in their relationships and endeavors, often serving as catalysts for positive change.',
      strengths: [
      ...
      learningStyle:
        'Learn best through hands-on experience, personal connection to material, and creative expression. Prefer flexible learning environments that allow for self-direction.',
  ...
  const currentType =
    mbtiDescriptions[personalityType] || mbtiDescriptions['INFP'];
    ...
    <div className="heading">
      ...
      <div className="ocean-results-container">
        <div className="results-header">
          ...
          <p>
            Discover your unique personality profile based on the Big Five
            (OCEAN) model
          </p>
        </div>
            ...
            <div className="detail-card">
              ...
              <div className="type-tags">
                {currentType.compatibleTypes.map((type, index) => (
                  <span key={index} className="type-tag compatible">
                    {type}
                  </span>
                ))}
              </div>
            ...
            <div className="detail-card">
              ...
              <div className="type-tags">
                {currentType.leastCompatible.map((type, index) => (
                  <span key={index} className="type-tag challenging">
                    {type}
                  </span>
                ))}
              </div>
