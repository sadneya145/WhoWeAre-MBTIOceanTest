                            ...
                            <div style={styles.contactSection}>
                                ...
                                <div style={styles.contactInfo}>
                                    ...
                                    <p style={styles.contactEmail}>
                                        ...
                                        <a href="mailto:whoweare@gmail.com" style={styles.emailLink}>
                                            whoweare@gmail.com
                                        </a>
                                    </p>
                                    <div style={styles.contactSocial}>
                                        <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" style={styles.socialLink} className="social-link">
                                            <i className="fab fa-linkedin" style={{ fontSize: '24px', color: 'white' }}></i>
                                        </a>
                                        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" style={styles.socialLink} className="social-link">
