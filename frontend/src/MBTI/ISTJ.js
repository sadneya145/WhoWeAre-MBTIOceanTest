    ...
    <div className="personality-container istj-theme">
      ...
      <section className="personality-section strengths-weaknesses-section">
        ...
        <div className="content-with-image">
          <img
            src="/images/istj-strengths-weaknesses.jpg"
            alt="Strengths and Weaknesses Visual - balanced scales or gears"
      ...
      <section className="personality-section video-section">
        ...
        <div className="video-wrapper">
          ...
          <iframe
            src="https://www.youtube.com/embed/your-istj-video-id"
            title="Understanding the ISTJ Personality Type"
            frameBorder="0"
        ...
        <p className="video-note">
          *Note: Replace "your-istj-video-id" with a relevant YouTube video ID
          for optimal content.
        </p>
      </section>
